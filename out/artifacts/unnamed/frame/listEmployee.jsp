...
<table cellspacing="0" border="1" class="table1">
    ...
    <s:iterator value="list" var="e">
        <tr>
            ...
            <td align="center"><a href="employee_edit.action?eid=<s:property value="eid"/>"><img src="../images/编辑.png"</a></a>
            </td>
            < align="center"><a href="employee_delete.action?eid=<s:property value="eid"/>"></img
